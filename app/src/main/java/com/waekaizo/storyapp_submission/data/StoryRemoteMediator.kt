...
import com.waekaizo.storyapp_submission.data.database.RemoteKeys
...
class StoryRemoteMediator(
    ...
    override suspend fun load(
        ...
        try {
            ...
            val response = ApiConfig.getApiService(pref.token).getStories(page, state.config.pageSize)
            val responseData = response.listStory.map { data ->
                ListStoryItem(
                    data.photoUrl,
                    data.createdAt,
                    data.name,
